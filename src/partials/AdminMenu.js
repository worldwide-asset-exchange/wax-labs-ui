...
export default function RenderAdminMenu() {
    return (
        <div className="admin-menu">
            ...
            <Link to="/proposals/in-review" className="admin-dashboard-item"><img src={reviewProposals} /><span className="label">Proposals to Review</span></Link>
            <Link to="/deliverables" className="admin-dashboard-item"><img src={tokens} /><span className="label">Devliverables to Review</span></Link>
