...
def upgrade() -> None:
    ...
    op.alter_column("proposals", "status", existing_type=old_enum, type_=new_enum, existing_nullable=True)
...
def downgrade() -> None:
    ...
    op.alter_column("proposals", "status", existing_type=new_enum, type_=old_enum, existing_nullable=True)
