...
export const PROPOSAL_QUERY_ARGS_DICT = {
    ...
    [PROPOSAL_INPROGRESS_KEY]: {bound: PROPOSAL_INPROGRESS_KEY, indexPosition: PROPOSALS_TABLE_STATUS_INDEXPOSITION},
...
export const PROPOSAL_ALL_QUERY_ARGS_LIST = [
    ...
    PROPOSAL_QUERY_ARGS_DICT[PROPOSAL_INPROGRESS_KEY],
