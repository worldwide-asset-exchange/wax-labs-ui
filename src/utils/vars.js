...
export const PROPOSALS_HEADER_LINk = `${PROPOSALS_LINK}?${PAGE_QUERY_STRING_KEY}=1&${STATUS_QUERY_STRING_KEY}=${VOTING_KEY},${PROPOSAL_INPROGRESS_KEY}`
...
export const PROPOSALS_IN_PROGRESS_LINK = `${PROPOSALS_LINK}?${STATUS_QUERY_STRING_KEY}=${PROPOSAL_INPROGRESS_KEY}`
export const PROPOSALS_IN_REVIEW_LINK = `${PROPOSALS_LINK}?${STATUS_QUERY_STRING_KEY}=${SUBMITTED_KEY}`
export const PROPOSALS_COMPLETED_LINK = `${PROPOSALS_LINK}?${STATUS_QUERY_STRING_KEY}=${COMPLETED_KEY}`
